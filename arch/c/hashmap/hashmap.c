...
// continue hasmap
typedef struct {
  Node** arr;  // TODO: fymann it up, explain why this makes sense? why void**
               // makes sense? i think this is similar to the dynamic array
               // exercise, where we need void**
} Hashmap;
...
// TODO: i am still confuse about size of, really see sizeof in action.
// sizeof arr: size of the pointer arr
// sizeof *arr: size of the type arr points to, which is int in this case.
Hashmap* Hashmap_new() {
...
// TODO: check with valgrine, but this is the last step
// do a code review with agent
...
// TODO: CRITICAL: Current implementation does not free individual nodes
