...
int main(void) {
  ...
  assert(pangram("thequickbrownfoxjumpsovertehlazydog") == 1);
  assert(pangram("aabcdefghijklmnopqrstuvwxyzz") == 1);
  ...
  assert(pangram("AABCdefGHIjklMNOpqrSTUvwxYZZ") == 1); // mixed case
